...
var
  ...
  vStartDatum, vEindDatum: integer;
  vConditie, vBestTrainingDagen: integer;
...
begin
  ...
  begin
    ...
    vStartDatum := vStartJaar * 112 + vStartDagen;
    vEindDatum := aEindJaar * 112 + aEindDagen;
    vBestTrainingDagen := vEindDatum - vStartDatum;
